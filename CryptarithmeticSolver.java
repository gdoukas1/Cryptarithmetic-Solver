...
public class CryptarithmeticSolver {
	...
	public static void main(String[] args) {
		HashMap<Character, Integer> char‘ÔIntMap = new HashMap<Character, Integer>();
		...
		char‘ÔIntMap.clear();
		String unique = uniqueSymbols(char‘ÔIntMap, s1, s1, s2);
		solution = false;
		
		
		solvePuzzle(unique, 0, char‘ÔIntMap, usedNumbers, s1, s1, s2, numberingSystem);
		if( solution == false)
		...
		char‘ÔIntMap.clear();
		unique = uniqueSymbols(char‘ÔIntMap, s3, s3, s2);
		solution = false;
		
		
		solvePuzzle(unique, 0, char‘ÔIntMap, usedNumbers, s3, s3, s2, numberingSystem);
		if( solution == false)
			System.out.println("No solution found");
		System.out.println();
		...
		usedNumbers = new boolean[numberingSystem];
		char‘ÔIntMap.clear();
		unique = uniqueSymbols(char‘ÔIntMap, s4, s4, s3);
		solution = false;
		
		
		
		solvePuzzle(unique, 0, char‘ÔIntMap, usedNumbers, s4, s4, s3, numberingSystem);
		if( solution == false)
			System.out.println("No solution found!");
		System.out.println();
	}
